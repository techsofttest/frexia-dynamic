...
const sidebarIcons = [
  ...
  <svg key="digital" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" />
  </svg>,

  <svg key="briefcase" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <rect x="2" y="7" width="20" height="14" rx="2" ry="2" />
    <path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" />
  </svg>,

  <svg key="leaf" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const bottomIcons = [
  ...
  <svg key="chart" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="w-full md:w-1/2 relative pt-12 sm:pt-16 md:pt-20">
          <div className="relative h-[300px] sm:h-[380px] md:h-[460px] w-full rounded-2xl bg-gray-50/50">
            ...
            {content1.image ? (
              <img
                src={content1.image}
                alt={content1.title || "Frexia Logistics Experts"}
